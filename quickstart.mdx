...
- World Engine v2 project ([quickstart](https://world.dev/quickstart))
...
If you need help, please drop by our Discord channel (TODO).

</Accordion>

## Making your first query

You've now spawned you first player. With that, we can `query` the world state and see that the player exists:
