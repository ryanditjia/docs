...
<Warning>
  **Note**: This quickstart assumes that you are using Linux or MacOS. If you are using Windows, we
...
<img className="block" src="/images/world-create.png" alt="CLI: world create" />
...
### Start World Engine stack in development mode

Once you have scaffolded your project, you can start World Engine stack in development mode by running the following
