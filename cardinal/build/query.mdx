---
title: Query
description: Understanding queries in World Engine v2 - how to read the game state
---

The Query API provides your game clients access to the game state. Unlike commands, queries are read-only and retrieve
information about entities, components, and world state.

<Tip>
  Looking for how to query game state in your systems? See [Querying the Game
  State](/cardinal/build/system/overview#querying-the-game-state)
</Tip>
